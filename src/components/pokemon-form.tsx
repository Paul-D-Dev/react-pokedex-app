...
const PokemonForm: FunctionComponent<Props> = ({pokemon, isEditForm}) => {
  ...
  const validateForm = () => {
    ...
    if(isAddForm()) {
      const start = "https://asset.pokemon.com/assets/cm2/img/pokedex/detail/";
      const end = ".png";
            ...
            <div className="card-stacked">
              <div className="card-content">
                ...
                <div className="form-group">
                  ...
                  <input id="name" type="text" name="name" className="form-control" placeholder="Nom du Pokémon" value={form.name.value} onChange={e => handleInputChange(e)}></input>
                  {form.name.error &&
                  <div className="card-panel red accent-1">
                    {form.name.error}
                  </div>
